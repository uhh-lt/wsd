...
const modelDescriptions = {
    ...
    'cos_traditional_self': {
        title: "Word Senses with Context Features",
    ...
    'naivebayes_cosets1k_self': {
        title: "Super Senses with Cluster Features",
    ...
    'naivebayes_cosets1k_coocwords': {
        title: "Super Senses with Context Features",
    ...
    'external_model_depslm': { // This is an external model. The host is configured with REACT_APP_WSP_EXTERNAL_API_ENDPOINT
        title: "Word Senses with Dependencies & Language Model Features",
        text: <span>This representation is based on two types of features: <b>syntactic dependencies</b> extracted using the Stanford parser and lexical <b>context features</b> extracted using a language model. This model was induced from the Wikipedia text corpus.</span>,
    },
};
